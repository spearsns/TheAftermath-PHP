  ...
  <body>
    <div class="container-fluid">
      ...
      <form id="newCharacter" method="post" action="inc/processNewCharacter.php">
        ...
        <div class='row black'>
          <div class='col-6 col-md'><h4 class='text-white text-center pt-2'>ETHNICITY:</h4></div>
          <div class='col-6 col-md'>
            <div class="input-group input-group-lg">
              <input type="text" id="ethnicity" name="ethnicity" class="form-control border text-center" readonly />
            </div>
          </div>
          <div class='col-6 col-md'><h4 class='text-white text-center pt-2'>AGE:</h4></div>
          <div class='col-6 col-md'>
            <div class="input-group input-group-lg">
        ...
        <div class='row black'>
          <div class='col-6 col-md'><h4 class='text-white text-center pt-2'>BACKGROUND:</h4></div>
          <div class='col-6 col-md'>
            <div class="input-group input-group-lg">
              <input type="text" id="background" name="background" class="form-control border text-center" readonly />
            </div>
          </div>
          <div class='col-6 col-md'><h4 class='text-white text-center pt-2'>SEX:</h4></div>
          <div class='col-6 col-md'>

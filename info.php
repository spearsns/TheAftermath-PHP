      ...
      <div class="accordion py-3" id="accordion">
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingOne">
            <button class="btn btn-dark btn-lg half border px-0" id='rolesBtn' type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
              ROLE PLAYING
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingTwo">
            <button class="btn btn-dark btn-lg half border px-0" id='traitsBtn' type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              TRAITS & CHECKS
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingThree">
            <button class="btn btn-dark btn-lg half border px-0" id='skillsBtn' type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
              SKILLS & CHECKS
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingFour">
            <button class="btn btn-dark btn-lg half border px-0" id='roundsBtn' type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
              ROUNDS & ACTIONS
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingFive">
            <button class="btn btn-dark btn-lg half border px-0" id='strikesBtn' type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
              STRIKES & L.O.S
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingSix">
            <button class="btn btn-dark btn-lg half border px-0" id='effectsBtn' type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
              EFFECTS & DAMAGE
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingSeven">
            <button class="btn btn-dark btn-lg half border px-0" id='meleeBtn' type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
              MELEE & ARMOR
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingEight">
            <button class="btn btn-dark btn-lg half border px-0" id='grapplingBtn' type="button" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
              GRAPPLING & HOLDS
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingNine">
            <button class="btn btn-dark btn-lg half border px-0" id='woundsBtn' type="button" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
              WOUNDS & BLOOD
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingTen">
            <button class="btn btn-dark btn-lg half border px-0" id='experienceBtn' type="button" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
              EXPERIENCE
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingEleven">
            <button class="btn btn-dark btn-lg half border px-0" id='animalsBtn' type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
              ANIMALS & NPC'S
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingTwelve">
            <button class="btn btn-dark btn-lg half border px-0" id='tacticalBtn' type="button" data-toggle="collapse" data-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">
              TACTICAL GEAR
            </button>
          </div>
        ...
        <div class="card">
          <div class="card-header brass text-center" id="headingThirteen">
            <button class="btn btn-dark btn-lg half border px-0" id='firstCharBtn' type="button" data-toggle="collapse" data-target="#collapseThirteen" aria-expanded="false" aria-controls="collapseThirteen">
              FIRST CHARACTER
            </button>
          </div>

	        ...
	        echo "
	            <div class='row black py-1'>
	      	 	  <div class='col-6 d-lg-none'>
	          		<img src='../img/graffiti/username.png' class='img-fluid h-100 mx-auto d-block' />
	        	  </div>
	              <div class='col-6 col-lg-2'>
	                <div class='input-group input-group-lg'>
	      	 	  ...
	      	 	  <div class='col-6 d-lg-none'>
	          		<img src='../img/graffiti/nameStencilWhite.png' class='img-fluid h-100 mx-auto d-block' />
	        	  </div>
	              <div class='col-6 col-lg-2'>
	                <div class='input-group input-group-lg'>

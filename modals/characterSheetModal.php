      ...
      <div class="modal-body">
        <div class='container-fluid'>
          ...
          <div class='characterSheet my-4'>
            ...
            <div class='row'>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>NAME:</strong></h6></div>
              ...
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>BACKGROUND:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="Background" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>HABITAT:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="Habitat" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>ETHNICITY:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
              ...
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>SEX:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="Sex" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>HAIR STYLE:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="HairStyle" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>HAIR COLOR:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="HairColor" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>FACIAL HAIR:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="FacialHair" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>EYE COLOR:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="EyeColor" class="form-control border text-center demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>EXP POOL:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">
                  <input type="text" id="RemainingExp" class="form-control border text-center experience demographic px-0" value="" readonly />
                </div>
              </div>
              <div class='col-6 col-md-3 py-1'><h6 class='pt-3 text-center'><strong>TOTAL EXP:</strong></h6></div>
              <div class='col-6 col-md-3 py-1'>
                <div class="input-group input-group-lg">

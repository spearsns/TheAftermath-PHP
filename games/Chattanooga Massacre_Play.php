      ...
      <div class='row metal py-2'>
        ...
        <div class='row'>
            ...
            <div class='row'>
              <div class='col'>
                <form id="send-message-area">
                  <textarea id="sendie" maxlength='300' class='w-100' rows='1' ></textarea>            
                </form>
              </div>
            </div>
          </div>
          ...
          <div class='col-12 col-md-4 col-lg-3 brass interface'>
            <div class='row'>
              <div class='order-1 col-6 col-md-12 py-2'>
              ...
              <div class='order-7 col-6 col-md-12 py-2'>

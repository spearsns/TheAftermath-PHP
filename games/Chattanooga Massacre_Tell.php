...
<html lang='en' dir='ltr'>
  ...
  <body onload="setInterval('chat.update()', 1250)">
      ...
      ?>
	    ...
	    <div class='row metal py-2'>
	      <div class='col-6 col-md-3'><img src='../img/graffiti/campaign.png' class='img-fluid h-100 mx-auto d-block' /></div>
        <div class='col-6 col-md-3'>
          <div class="input-group input-group-lg">
            <input type="text" id="gameName" class="form-control border text-center" value='<?php echo $gameName; ?>' readonly />
          </div>
        </div>
        <div class='col-6 col-md-3 py-1'><img src='../img/graffiti/storyteller.png' class='img-fluid h-100 mx-auto d-block' /></div>
	        ...
	        <div class='row'>
	          <div class='col'>
	            <form id="send-message-area">
	              <textarea id="sendie" maxlength='300' class='w-100' ></textarea>            
	            </form>
	          </div>
	        </div>
        </div>
